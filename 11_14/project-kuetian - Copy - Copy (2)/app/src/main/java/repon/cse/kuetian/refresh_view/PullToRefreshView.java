package repon.cse.kuetian.refresh_view;
...
public class PullToRefreshView extends ViewGroup {
    ...
    public PullToRefreshView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, repon.cse.kuetian.R.styleable.RefreshView);
        final int type = a.getInteger(repon.cse.kuetian.R.styleable.RefreshView_type, STYLE_SUN);
        a.recycle();
